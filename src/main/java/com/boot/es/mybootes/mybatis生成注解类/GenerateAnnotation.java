package com.boot.es.mybootes.mybatis生成注解类;
import java.io.File;
...
public class GenerateAnnotation {
    ...
    public static void main(String[] args) throws Exception {
        String className = "com.boot.es.mybootes.clone.Child";
        generator(className);
    }
    ...
    private static void generateResultMap(String clzName) throws ClassNotFoundException {
        Class<?> clz = Class.forName(clzName);
        String className = clz.getSimpleName();
        System.out.println(MessageFormat.format("<resultMap type=\"{0}\" id=\"{1}ResultMap\">",clzName,className));
        ...
        for (Field field : fields) {
            ...
            String columnName = camelToUnderline(camelToUnderline(propertyName));
            System.out.println(MessageFormat.format("    <result property=\"{0}\" column=\"{1}\"/>",propertyName,columnName));
        }
